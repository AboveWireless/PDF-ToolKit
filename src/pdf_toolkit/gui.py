...
class MainWindow(QMainWindow):
    ...
    def _build_center_pane(self) -> QWidget:
        ...
        # All content above the footer goes into a single scrollable area so the
        # entire center column scrolls when content exceeds the window height,
        # instead of squishing widgets.  The footer stays pinned at the bottom.
        scroll_content = QWidget()
        scroll_content.setObjectName("FormHost")
        ...
        scroll_inner.addWidget(parameter_header)
        scroll_inner.addWidget(parameter_caption)
